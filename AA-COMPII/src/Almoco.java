...
public class Almoco extends JPanel {
  ...
  MySortedListModel destListModel;
  ...
  public static JList editorPane;
  
  public static JScrollPane editor;

  public ListModel cardapio;
  ...
  public void setVisible() {
    ...
    Almoco dual = new Almoco();
    dual.addSourceElements( new String[] {"Arroz Branco","Arroz Integral","Arroz Agulinha"
    		,"Arroz Parbolizado","Feijão Preto","Feijão Branco","Feijão Carioquinha","Feijão Fradinho"
    		,"Carne Assada","Bife de Panela","Carre ao Molho","Steak de Frango","Carne Moída"
    		,"Purê de Batata","Purê de Aipim","Polenta","Farofa c/ Molho a Campanha"
    		,"Acelga","Alface","Agrião","Couve","Bertalha","Couve","Espinafre","Rúcula"});
...
private class AddListener implements ActionListener {
  ...
  private class OkButton implements ActionListener{
	  public void actionPerformed(ActionEvent e){
		  TelaPrincipal.Almoco.repaint();
		  TelaPrincipal.almocoLista.setModel(destListModel);
		  f.dispose();  
	  }
  }
}
